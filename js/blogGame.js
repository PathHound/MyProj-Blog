...
var febPostRand = [
  ...
  "<div class='usrPost feb19'><h3>Castle of the Awesome!</h3><p class='date'>2|16|2019</p><p>I finished remodling my Rec Room! It looks great!</p>",
  "<div class='usrPost feb19'><h3>Junking it</h3><p class='date'>2|26|2019</p><p>Junk Post without the lorem ipsum</p>",
  "<div class='usrPost mar19'><h3>Scream</h3><p class='date'>3|1|2019</p><p>This just a fun extra post if it shows up.</p>",
  "<div class='usrPost feb19'><h3>Did someone say wizardry?</h3><p class='date'>2|26|2020</p><p>The day Harry potter died.... It was so tragic, this post is in the wrong year, it's from the future.</p>",
  "<div class='usrPost feb19'><h3>Megas XLR</h3><p class='date'>2|-1|2019</p><p>A giant robot with a car for a head; how much more insane and impressive can you get?</p>"];
...
//Month's Below, handling the switching of content between the home page and the back.
// Further updates needed.
for (var i = 0; i < 10; i += 1 ){
  var temp = febPostRand[Math.floor(Math.random() * 10)];
  $('#arcPost').append(temp);
  console.log(temp);
}
